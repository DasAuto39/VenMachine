          ...
          <div className="w-full h-full backdrop-blur-xl bg-emerald-50/95 border-b border-emerald-100 shadow-[0_2px_20px_rgba(16,185,129,0.08)] px-4 md:px-8 flex items-center justify-between" style={{ minHeight: '62px' }}>
            ...
            <div className="flex items-center gap-1.5">
              ...
              <button
                ...
                className="px-3.5 py-1.5 rounded-xl text-sm font-bold bg-white text-emerald-700 border border-emerald-200 hover:bg-emerald-50 hover:border-emerald-400 shadow-sm transition-all hover:shadow-md hover:-translate-y-0.5 whitespace-nowrap hidden sm:block"
              >
                Info &amp; Promo
              </button>
              <button
